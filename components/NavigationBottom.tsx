  ...
  return (
    <div className="sticky lg:hidden bottom-3 w-full flex justify-center items-center mb-3">
      <div className="flex flex-row py-2 px-2 lg:py-3 lg:px-3 bg-slate-500 border border-[#ffffff22] backdrop-blur-xl rounded-xl space-x-2 lg:space-x-3 bg-opacity-30">
        <Link href="/">
          <div className="flex flex-col w-[3rem] items-center justify-center text-center space-y-2">
            {currentPath === "/" ?
              <BsFillPersonFill
        ...
        <Link href="/projects">
          <div className="flex flex-col w-[3rem] overflow-hidden items-center justify-center text-center space-y-2">
