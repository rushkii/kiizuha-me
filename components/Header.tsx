...
const Headers = () => {
  ...
  return (
    <nav className="overflow-x-hidden w-full backdrop-blur border-b-[0.1px] relative z-10 border-b-[#cfcfd6] dark:border-[#cbd5e129] supports-backdrop-blur:bg-white/60 font-rubik">
