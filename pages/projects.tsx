...
const Projects = () => {
  return (
    <main className="relative flex flex-col justify-center items-center min-h-screen font-rubik">
      ...
      <div className="py-14 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 items-start">
        {projects.map((key, _) => {
          return (
