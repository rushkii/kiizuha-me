...
const Projects = () => {
  return (
    <main className="relative flex flex-col items-center min-h-screen mt-14 font-rubik">
      ...
      <div className={`mb-14 ${projects.length >= 3 ? "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4" : "flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4"} items-center justify-center`}>
        {projects.map((key, _) => {
          return (
